...
popular_df = joblib.load(
    open('/Users/jojojoseph/Documents/IITJ/MLBD_project/popular.pkl', 'rb'))
pt = joblib.load(
    open('/Users/jojojoseph/Documents/IITJ/MLBD_project/pt.pkl', 'rb'))
books = joblib.load(
    open('/Users/jojojoseph/Documents/IITJ/MLBD_project/books.pkl', 'rb'))
similarity_scores = joblib.load(open(
    '/Users/jojojoseph/Documents/IITJ/MLBD_project/similarity_scores.pkl', 'rb'))
    ...
    try:
        ...
        if user_input not in pt.index:
            ...
            close_matches = get_close_matches(
                user_input, available_titles, n=5, cutoff=0.5)
